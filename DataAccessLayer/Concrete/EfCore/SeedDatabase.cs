...
namespace shopapp.data.Concrete.EfCore
{
    public static class SeedDatabase
    {
        ...
        //private static List<ProductCategory> SeedProductCategories = new()
        //{
        //    new(){Product=SeedProducts[0],Category=SeedCategories[0]},
        //    new(){Product=SeedProducts[0],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[1],Category=SeedCategories[0]},
        //    new(){Product=SeedProducts[1],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[2],Category=SeedCategories[0]},
        //    new(){Product=SeedProducts[2],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[3],Category=SeedCategories[0]},
        //    new(){Product=SeedProducts[3],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[4],Category=SeedCategories[0]},
        //    new(){Product=SeedProducts[4],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[5],Category=SeedCategories[0]},
        //    new(){Product=SeedProducts[5],Category=SeedCategories[2]},

        //    new(){Product=SeedProducts[6],Category=SeedCategories[1]},
        //    new(){Product=SeedProducts[6],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[7],Category=SeedCategories[1]},
        //    new(){Product=SeedProducts[7],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[8],Category=SeedCategories[1]},
        //    new(){Product=SeedProducts[8],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[9],Category=SeedCategories[1]},
        //    new(){Product=SeedProducts[9],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[10],Category=SeedCategories[1]},
        //    new(){Product=SeedProducts[10],Category=SeedCategories[2]},
        //    new(){Product=SeedProducts[11],Category=SeedCategories[1]},
        //    new(){Product=SeedProducts[11],Category=SeedCategories[2]}
        //};
    }
}