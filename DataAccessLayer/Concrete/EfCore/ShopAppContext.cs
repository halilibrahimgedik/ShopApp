...
namespace DataAccessLayer.Concrete.EfCore
{
    public class ShopAppContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // //? Data Seeding Bu işlemleri SeedDatabase.cs static sınıfında hallediyoruz artık ama orada ilişkili veri ekliyemiyoruz(Context nesnesi üzerinden veri eklediğimiz için ProductCategory sınıfı olmadığı için)
